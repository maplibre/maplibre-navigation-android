...
class NavigationHelperTest : BaseTest() {
    ...
    fun increaseIndex_increasesStepByOne() {
        ...
        val previousIndices = NavigationIndices.create(0, 0)
    ...
    fun increaseIndex_increasesLegIndex() {
        ...
        val previousIndices = NavigationIndices.create(0, 21)
    ...
    fun checkMilestones_onlyTriggeredMilestonesGetReturned() {
        ...
        mapLibreNavigation.addMilestone(
            StepMilestone.Builder()
                .setTrigger(eq(TriggerProperty.STEP_INDEX, 0))
                .setIdentifier(1001).build()
        )
        mapLibreNavigation.addMilestone(
            StepMilestone.Builder()
                .setTrigger(eq(TriggerProperty.STEP_INDEX, 4))
    ...
    fun offRouteDetectionDisabled_isOffRouteReturnsFalse() {
        ...
        val model = NavigationLocationUpdate.create(
            Mockito.mock(
                Location::class.java
            ), mapLibreNavigation
        )
        ...
        val userOffRoute = isUserOffRoute(
            ...
            ), Mockito.mock(OffRouteCallback::class.java)
        )
    ...
    fun createIntersectionDistanceList_samePointsForDistanceCalculationsEqualZero() {
        ...
        Assert.assertTrue(intersectionDistances[0].second == 0.0)
    }
    ...
    fun findCurrentIntersection_beginningOfStepReturnsFirstIntersection() {
        ...
        val intersectionDistances: List<Pair<StepIntersection, Double>> =
    ...
    fun createCurrentAnnotation_nullAnnotationReturnsNull() {
        val currentLegAnnotation = createCurrentAnnotation(
            null, Mockito.mock(RouteLeg::class.java), 0.0
        )
    ...
    private fun buildRouteLegWithAnnotation(): RouteLeg {
        val routeLeg = Mockito.mock(
            RouteLeg::class.java
        )
        val legAnnotation = LegAnnotation.builder()
            .distance(ArrayList())
            .build()
        Mockito.`when`(routeLeg.annotation()).thenReturn(legAnnotation)
        return routeLeg
    }
