...
class SnapToRouteTest : BaseTest() {
    ...
    fun snappedLocation_locationOnStart() {
            ...
            Assert.assertEquals(38.798979, snappedLocation.latitude)
    ...
    fun snappedLocation_locationOnStep() {
            ...
            Assert.assertEquals(38.79840909601134, snappedLocation.latitude)
    ...
    fun snappedLocation_locationOnEnd() {
            ...
            Assert.assertEquals(38.9623092, snappedLocation.latitude)
