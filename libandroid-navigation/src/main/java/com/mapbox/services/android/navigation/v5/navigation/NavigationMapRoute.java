...
// TODO:
// draw primary route eating (when enabled)
// or draw full primary route (when disabled)
// draw alternative routes
// draw waypoints ?!
// draw traffic congestion
// draw upcoming maneuver arrow
// handle route updates
// handle change primary route
// Allow customize route stylings
...
//    private static final String DRIVEN_ROUTE_SOURCE_ID = "mapbox-navigation-driven-route-source";
//    private static final String DRIVEN_ROUTE_LAYER_ID = "mapbox-navigation-driven-route-layer";
...
//    private static final String DRIVEN_ROUTE_SHIELD_LAYER_ID = "mapbox-navigation-driven-route-shield-layer";
...
//////            layerIds.add(String.format(Locale.US, ID_FORMAT, DRIVEN_ROUTE_SHIELD_LAYER_ID, index));
//////            layerIds.add(String.format(Locale.US, ID_FORMAT, DRIVEN_ROUTE_LAYER_ID, index));
...
////            // bottom.
//////            addDrivenRouteShieldLayer(layerIds.get(layerIds.size() - 4), sourceId, index);
//////            addRouteLayer(layerIds.get(layerIds.size() - 3), sourceId, index);
...
////    }
////
////    private void updateDrivenShieldRoute(String layerId, int index) {
////        if (mapboxMap.getStyle() != null) {
////            Layer layer = mapboxMap.getStyle().getLayer(layerId);
////            if (layer != null) {
////                layer.setProperties(
////                        PropertyFactory.lineColor(routeDrivenColor),
////                        PropertyFactory.lineWidth(600f)
////                );
////                if (index == primaryRouteIndex) {
////                    mapboxMap.getStyle().removeLayer(layer);
////                    mapboxMap.getStyle().addLayerBelow(layer, WAYPOINT_LAYER_ID);
...
////    }
////
////    private void addDrivenRouteShieldLayer(String layerId, String sourceId, int index) {
////        if (index != primaryRouteIndex) {
////            return;
////        }
////
...
////        routeDrivenColor = typedArray.getColor(R.styleable.NavigationMapRoute_drivenRouteColor,
////                ContextCompat.getColor(context, R.color.mapbox_navigation_route_layer_congestion_red));
////
...
////    }
////
////    private void initDrivenRouteLayers() {
////        initDrivenRouteShield();
////    }
////
////    private void initDrivenRouteShield() {
////        if (mapboxMap.getStyle() != null) {
////            Layer layer = new LineLayer(DRIVEN_ROUTE_SHIELD_LAYER_ID, DRIVEN_ROUTE_SOURCE_ID)
////                    .withProperties(
////                    PropertyFactory.lineCap(Property.LINE_CAP_ROUND),
////                    PropertyFactory.lineJoin(Property.LINE_JOIN_ROUND),
////                    PropertyFactory.lineWidth(30f),
////                    PropertyFactory.lineColor(routeDrivenColor)
////            );
////
////            mapboxMap.getStyle().removeLayer(layer);
////            MapUtils.addLayerToMap(mapboxMap, layer, belowLayer);
//////            mapboxMap.getStyle().addLayerBelow(layer, GENERIC_ROUTE_SHIELD_LAYER_ID);
////        }
////    }
////
